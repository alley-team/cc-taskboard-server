...
Настройка базы данных проводится единожды, создавая в PostgreSQL три таблицы для хранения данных.
...
Для работы метода необходимо передать токен в заголовке `App-Token`, а в теле запроса - JSON вида:
